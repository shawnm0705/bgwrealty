		...
		<div class="col-md-10 col-md-offset-1">
			...
			<?php echo $this->Form->create('Property'); ?>
				...
				<?php
					...
					echo '<div class="input text"><label for="PropertyPriceMin">价格范围</label>$<input name="data[Property][price_min]" type="text" id="PropertyPriceMin" class="input-100" value="'.$price_min.'"/> 000&nbsp;-&nbsp;$<input name="data[Property][price_max]" type="text" id="PropertyPriceMax" class="input-100" value="'.$price_max.'"/> 000</div>';
