	...
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-2">
			<dl class="dl-view dl-250">
				...
				echo $this->Html->link(__('Sales Advise Form'), array('employee' => false, 'action' => 'saf', $id), array('target' => '_blank'));
				echo '<h2>出合同</h2>
					<dt>记录时间</dt>
		...
		<center style="margin-bottom:20px;"><?php echo $this->Html->link(__('修改现阶段销售信息'), array('action' => 'edit', $deal['Deal']['id']), array('class' => 'btn btn-custom button-action')); ?></center>
	</div>
</div>
