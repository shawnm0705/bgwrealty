	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<?php echo $this->Form->create('Deal', array('enctype' => 'multipart/form-data')); 
				...
				switch ($status){
					case 'C':
						echo $this->Form->input('customer_id', array('label' => '客户', 'type' => 'select', 'options' => $customers, 'div' => array('class' => 'input required')));
						echo $this->Form->input('property_id', array('label' => '楼盘', 'type' => 'select', 'options' => $properties, 'div' => array('class' => 'input required')));
						echo $this->Form->input('c_unitno', array('label' => '房号', 'type' => 'text'));
						echo $this->Form->input('c_htjg', array('label' => '合同价格', 'type' => 'text'));
						echo $this->Form->input('c_yhje', array('label' => '优惠金额', 'type' => 'text'));
						echo $this->Form->input('c_djje', array('label' => '定金金额', 'type' => 'text'));
						echo $this->Form->input('c_djzh', array('label' => '定金帐户', 'type' => 'textarea'));
						echo $this->Form->input('c_djpz', array('label' => '定金凭证', 'type' => 'file'));
						echo $this->Form->input('c_gmmd', array('label' => '购买目的', 'type' => 'select', 'options' => array('投资' => '投资', '自住' => '自住')));
						echo $this->Form->input('c_khsf', array('label' => '客户身份', 'type' => 'select', 'options' => array('PR/Citizen' => 'PR/Citizen', '海外人士' => '海外人士')));
						echo '<h2>合同姓名1 </h2>';
						...
						echo $this->Form->input('c_htsj', array('label' => '预约合同签定时间', 'type' => 'text'));
						break;	
					case 'Q':
						echo $this->Form->input('q_htsj', array('label' => '合同签定时间','type' => 'text'));
						echo $this->Form->input('q_10sj', array('label' => '10%余额时间','type' => 'text'));
						echo $this->Form->input('q_10je', array('label' => '10%余额金额', 'type' => 'text'));
						echo $this->Form->input('q_10zh', array('label' => '10%余额帐户', 'type' => 'textarea'));
						echo $this->Form->input('q_10pz', array('label' => '10%余额凭证', 'type' => 'file'));
						break;
					case 'J':
						echo $this->Form->input('j_htsj', array('label' => '合同时间','type' => 'text'));
						echo $this->Form->input('j_lshh', array('label' => '律师回函', 'type' => 'file'));
						echo $this->Form->input('j_htsy', array('label' => '合同首页', 'type' => 'file'));
						break;
					case 'D':
						echo $this->Form->input('d_sdsj', array('label' => '申贷时间','type' => 'text'));
					...
					case 'CZ':
						...
						echo $this->Form->input('cz_htsj', array('label' => '管理合同签定时间','type' => 'text'));
						echo $this->Form->input('cz_ggsj', array('label' => '出租广告时间','type' => 'text'));
						echo $this->Form->input('cz_zfhtsj', array('label' => '租房合同签定时间','type' => 'text'));
						echo $this->Form->input('cz_je', array('label' => '出租金额', 'type' => 'text'));
